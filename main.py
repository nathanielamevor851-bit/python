...
def alMart():                                                                         # Defining the main function 1 Usage
    ...
    def loginLayout():
        ...
        PasswordEntry.bind("<FocusIn>", PasswordEntry_Enter)                         # Adding focusIn event
        PasswordEntry.bind("<FocusOut>", PasswordEntry_Leave)                        # Adding focusOut event
    ...
    def signLayout():                                                                # Creating a new layout
        ...
        def DOBEntry_Enter(*args):
            if DOBEntry.get() == "Date Of Birth":                                     # Checking if entry box is empty
